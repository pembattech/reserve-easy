<x-vendor-layout>
    ...
    <main class="flex-grow p-6 bg-white">
                ...
                <tbody>
                    @foreach ($vendor->bookings as $booking)
                        <tr class="border-b" id="booking-row-{{ $booking->id }}">
                            ...
                            <td class="px-6 py-4">
                                @if ($booking->client->booking_source == 'online')
                                    <span>{{ $booking->client->booking_source }}</span>
                                @else
                                    <span>{{ $booking->client->booking_source }}</span>
                                @endif
                            </td>
        ...
        <!-- Popup Container -->
        <div id="popup-addbooking"
            class="fixed inset-0 hidden bg-gray-800 bg-opacity-50 flex items-center justify-center">
                ...
                <form id="bookingForm" method="POST" novalidate class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="guest" name="guest" min="1"
                                class="mt-1 block w-full border border-gray-300 rounded-md p-2" required>
                    ...
                    <div class="flex justify-end space-x-2 mt-4">
                        <button type="button" id="closePopup-addbooking"
